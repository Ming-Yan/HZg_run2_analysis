...
Float_t HZgkin_MVA(TreeReader &data, Int_t channel, int period, HZgVariables &HZgVar, vector<float> &phocorval)
{
  //define
  ...
  float gR9_    = phocorval[4];
  //cout<<gR9_<<endl;
  //float gMVA_   = phoIDMVA[HZgVar.phoID_];//offical id
  float gMVA_ =  phocorval[10];
  float costheta    = HZgVar.HZgcostheta;
  float cosTheta    = HZgVar.HZgcosTheta;
  float Phi       = HZgVar.HZgPhi;
  float dEtaZg = fabs(HZgVar.vec_higgs.Eta()-HZgVar.vec_pho.Eta());
  float phores = phoSigmaE[HZgVar.phoID_]/phoE[HZgVar.phoID_];
  ...
  if(!reader)
    {
      ...
      reader->AddVariable("cor_newphoMVA",    &_phoMVA );
      ...
      string file;
      //file = "MVAout/discr_MVA0210__HZg_usemva_tree3500_lrate0.6_depth4__BDT.weights.xml";
      file  = "MVAout/discr_chargelep__HZg_noptwei_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //      file = "MVAout/discr_chargelep__HZg_new_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //      file = "MVAout/discr_mvaWP90__HZg_cormva_tree3500_lrate0.6_depth4__BDT.weights.xml";
  ...
  if(!readerVBF)
    {
      ...
      //file = "MVAout/VBF_discr_MVA0305__HZg__tree1000_lrate0.6_depth4_usemva_BDT.weights.xml";
      //file = "MVAout/VBF_discr_chargelep__HZg__tree1000_lrate0.6_depth4_new_BDT.weights.xml";
      //      file = "MVAout/VBF_discr_mvaWP90__HZg__tree1000_lrate0.6_depth4_cormva_BDT.weights.xml";
      file = "MVAout/VBF_discr_ptwei__HZg__tree1000_lrate0.6_depth4_nowei_BDT.weights.xml";
...
Float_t update_VBFMVA(HZgVariables &HZgVar,float kinMVA)
{

  TLorentzVector dijet;
  dijet = HZgVar.vec_jet[0]+HZgVar.vec_jet[1];
  float VBFPt1_ = HZgVar.vec_jet[0].Pt();
  float VBFPt2_ = HZgVar.vec_jet[1].Pt();
  // float mjj_ = dijet.M();
  // float CZg_ = exp(-4/pow(jet[0].Eta()-jet[1].Eta(),2)*pow(HZgVar.vec_higgs.Eta()-((jet[0].Eta()+jet[1].Eta())/2),2));
  float dEta_jj_ = HZgVar.vec_jet[1].Eta()-HZgVar.vec_jet[0].Eta();
  float absdEta_jj_ = fabs(HZgVar.vec_jet[1].Eta()-HZgVar.vec_jet[0].Eta());
  float dPhi_Zgjj_ = dijet.DeltaPhi(HZgVar.vec_higgs);
  float absdPhi_Zgjj_ = fabs(dijet.DeltaPhi(HZgVar.vec_higgs));
  float dPhi_jj_ = HZgVar.vec_jet[1].DeltaPhi(HZgVar.vec_jet[0]);
  float absdPhi_jj_ = fabs(HZgVar.vec_jet[1].DeltaPhi(HZgVar.vec_jet[0]));
  float ZgPTt_    = 2*fabs(HZgVar.vec_Z.Px()*HZgVar.vec_pho.Py()-HZgVar.vec_Z.Py()*HZgVar.vec_pho.Px())/HZgVar.vec_higgs.Pt();
  // float Zeppen_ = HZgVar.vec_higgs.Eta()-(HZgVar.vec_jet[0].Eta()+HZgVar.vec_jet[1].Eta())/2;
  // float absZeppen_ = fabs(HZgVar.vec_higgs.Eta()-(jet[0].Eta()+jet[1].Eta())/2);  
  float absZeppen_pho_ = fabs(HZgVar.vec_pho.Eta()-(HZgVar.vec_jet[0].Eta()+HZgVar.vec_jet[1].Eta())/2);
  float dR_phojet_ = min(HZgVar.vec_jet[1].DeltaR(HZgVar.vec_pho),HZgVar.vec_jet[0].DeltaR(HZgVar.vec_pho));
  float HZgMVA_ = kinMVA;
  float abssysbal_ = fabs((HZgVar.vec_pho.Px()+ HZgVar.vec_Z.Px()+HZgVar.vec_jet[0].Px()+HZgVar.vec_jet[1].Px()+HZgVar.vec_pho.Py()+ HZgVar.vec_Z.Py()+ HZgVar.vec_jet[0].Py()+HZgVar.vec_jet[1].Py())/(HZgVar.vec_pho.Pt()+HZgVar.vec_Z.Pt()+HZgVar.vec_jet[0].Pt()+HZgVar.vec_jet[1].Pt()));
  static float _mjj,_CZg, _absdEta_jj,_absdPhi_Zgjj,_absdPhi_jj,_ZgPTt, _VBFPt1, _VBFPt2,_absZeppen,_dR_phojet,_HZgMVA,_absZeppen_pho,_abssysbal;
  ...
  if(!readerVBF)
    {
      ...
      // if(period==17)file = "MVAout/VBF_discr_Rereco17_VBFjet__HZg__tree1000_lrate0.6_depth4_mva_BDT.weights.xml";
      // if(period==17)file = "MVAout/VBF_discr_Rereco17_MVA1130__HZg__tree1000_lrate0.6_depth4_rmmva_BDT.weights.xml";
      // if(period==18)file = "MVAout/VBF_discr_Rereco18_MVA1130__HZg__tree1000_lrate0.6_depth4_mva_BDT.weights.xml";VBF_discr_MVA0305__HZg__tree1500_lrate0.6_depth4_usemva_BDT.weights.xml
      //file = "MVAout/VBF_discr_MVA0305__HZg__tree1000_lrate0.6_depth4_usemva_BDT.weights.xml";
      //file = "MVAout/VBF_discr_mvaWP90__HZg__tree1000_lrate0.6_depth4_cormva_BDT.weights.xml";
      //file = "MVAout/VBF_discr_chargelep__HZg__tree1000_lrate0.6_depth4_new_BDT.weights.xml";
      file = "MVAout/VBF_discr_ptwei__HZg__tree1000_lrate0.6_depth4_nowei_BDT.weights.xml";
      //file = "MVAout/VBF_discr_corpho__HZg__tree1000_lrate0.6_depth4_cormva_BDT.weights.xml";
      //      file = "MVAout/VBF_discr_chargelep__HZg__tree1000_lrate0.6_depth4_new_BDT.weights.xml";
      readerVBF->BookMVA(method.c_str(), file.c_str());
    }   
  // _mjj = mjj_; 
...
Float_t update_MVA(HZgVariables &HZgVar, float phoMVA, float phores,float phoR9)
{
  //define
  float lepEta1  = HZgVar.vec_lep[0].Eta();
  float lepEta2  = HZgVar.vec_lep[1].Eta();
  float mllgptdmllg = HZgVar.vec_higgs.Pt()/HZgVar.vec_higgs.M();
  float gMVA_   = phoMVA;//offical id
  float costheta    = HZgVar.HZgcostheta;
  float cosTheta    = HZgVar.HZgcosTheta;
  float Phi       = HZgVar.HZgPhi;
  float gres = phores;
  ...
  if(!reader)
    {
      ...
      reader->AddVariable("phoEta",   &_phoEta);
      reader->AddVariable("Phi",      &_Phi );
      //reader->AddVariable("cor_phoR9",    &_phoR9);
      reader->AddVariable("cor_newphoMVA",     &_phoMVA);
      ...
      //file = "MVAout/discr_chargelep__HZg_new_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //file = "MVAout/discr_chargelep__HZg_noptwei_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //file = "MVAout/discr_mvaWP90__HZg_test_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //file = "MVAout/discr_mvaWP90__HZg_test_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //file = "MVAout/discr_chargelep__HZg_noptwei_tree3500_lrate0.6_depth4__BDT.weights.xml";
      file  = "MVAout/discr_chargelep__HZg_noptwei_tree3500_lrate0.6_depth4__BDT.weights.xml";
      //file = "MVAout/discr_chargelep__HZg_new_tree3500_lrate0.6_depth4__BDT.weights.xml";
