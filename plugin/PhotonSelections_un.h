...
void PhotonIDMVA2016(TreeReader &data, vector<int>&accepted, vector<float> &phoEt) {
...
void PhotonIDMVA2016t(TreeReader &data, vector<int>&accepted,HZgVariables &HZgVar,int channel) {
...
void PhotonIDMVA2017(TreeReader &data, vector<int>&accepted,vector<float> &phoEt) {
