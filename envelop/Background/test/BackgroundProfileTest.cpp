...
int main(){
  ...
  TFile *bkgFile = TFile::Open("~/CMSSW_7_4_7/src/flashggFinalFit/Plots/FinalResults/bkg_ele_mu_6789.root");
  TFile *sigFile1 = TFile::Open("~/CMSSW_7_4_7/src/flashggFinalFit/Plots/FinalResults/WS_VBFMVA_v2_ele_mu_WH_6789_125.root");
  TFile *sigFile2 = TFile::Open("~/CMSSW_7_4_7/src/flashggFinalFit/Plots/FinalResults/WS_VBFMVA_v2_ele_mu_ZH_6789_125.root");
  TFile *sigFile3 = TFile::Open("~/CMSSW_7_4_7/src/flashggFinalFit/Plots/FinalResults/WS_VBFMVA_v2_ele_mu_ttH_6789_125.root");
  RooWorkspace *bkgWS = (RooWorkspace*)bkgFile->Get("multipdf");
  RooWorkspace *sigWS1 = (RooWorkspace*)sigFile1->Get("");
  RooWorkspace *sigWS2 = (RooWorkspace*)sigFile2->Get("");
  RooWorkspace *sigWS3 = (RooWorkspace*)sigFile3->Get("");
  ...
  for (int cat=firstCat; cat<=lastCat; cat++){
    ...
    RooDataHist *dataBinned = (RooDataHist*)bkgWS->data("roohist_data_mass_ele_mu_cat6789");
    RooDataSet *sigMC1 = (RooDataSet*)sigWS1->data("ele_mu_WH_125_cat6789");
    RooDataSet *sigMC2 = (RooDataSet*)sigWS2->data("ele_mu_ZH_125_cat6789");
    RooDataSet *sigMC3 = (RooDataSet*)sigWS3->data("ele_mu_ttH_125_cat6789");

    if (!dataBinned || !sigMC1||!sigMC2||!sigMC3){
	...
	sigMC1->append(*sigMC2);
	sigMC1->append(*sigMC3);
    modelBuilder.setSignalPdfFromMC(sigMC1);
    ...
    modelBuilder.throwToy(Form("cat6789_toy0",cat),dataBinned->sumEntries(),true,true);
    ...
    //cout << "Continue?" << endl;
    //string bus; cin >> bus;
    profiler.plotNominalFits(dataBinned,mass,55,Form("cat%d",cat));
    ...
    profiler.plot(correctedNlls.second,Form("cat6789_nlls",cat));
