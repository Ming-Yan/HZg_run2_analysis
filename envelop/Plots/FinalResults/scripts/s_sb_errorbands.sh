...
Muhat=$4
dir=$2 
((startIndex=$nToys*10000))
index=$startIndex
echo $index
echo $startIndex+$nToys
cd $dir
...
ls higgsCombinecombout_step0_$index*.root
mv higgsCombinecombout_step0_$index*.root higgsCombinecombout_step0_done_$index.root
...
ls higgsCombinecombout_step1_$index*.root
mv higgsCombinecombout_step1_$index*.root higgsCombinecombout_step1_done_$index.root
...
ls higgsCombinecombout_step2_$index*.root
mv higgsCombinecombout_step2_$index*.root higgsCombinecombout_step2_done_$index.root
